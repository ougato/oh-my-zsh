## 关于本仓（计划每月一更，最后更新时间：2021-10-25）
因 github 速度原因，将 oh-my-zsh 项目克隆至此！

对代码中的相关网址进行了替换（已在下面列出），以实现：
...
### 二、为安装及使用方便，修改3处：
#### 1. tools/install.sh 43行：Default settings
...
#### 2. tools/upgrade.sh 128行：Update upstream remote to ohmyzsh org
...
#### 3. templates/zshrc.zsh-template （~/.zshrc模板文件）
